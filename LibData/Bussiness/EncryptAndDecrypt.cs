...
namespace LibData.Bussiness
{
    ...
    {
        private static ILog logger = LogManager.GetLogger("EncryptAndDecrypt");
        ...
        public EncryptAndDecrypt(string encryptionKey, string IV)
        {
        ...
        {
            EncryptionKey = Encoding.UTF8.GetBytes(ConfigType.HungThinhKey);
            IV = Encoding.UTF8.GetBytes(ConfigType.HungThinhIV);
        }
